...
(function($, JSON) {
    ...
    XBlock = {
        ...
        initializeBlock: function(element, requestToken) {
            var $element = $(element), children, asides;
            requestToken = requestToken || $element.data("request-token");
...
$(document).ready(function() {
    ...
    function catchKeyPress(object, event) {
        ...
        if (event.which === keyCodes.upArrow || event.which === keyCodes.leftArrow || event.which === keyCodes.tab && event.shiftKey) {
            ...
            event.preventDefault()
        } else if (event.which === keyCodes.downArrow || event.which === keyCodes.rightArrow || event.which === keyCodes.tab) {
...
var DialogTabControls = function() {
    "use strict";
    var focusableChildren, numElements, currentIndex, focusableElementSelectors = "a, input[type=text], input[type=submit], select, textarea, button", setCurrentIndex = function(currentElement) {
...
var $focusedElementBeforeModal, focusableElementsString = "a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable]";
...
var trapFocusForAccessibleModal = function($previouslyFocusedElement, focusableElementsFilterString, closeButtonId, modalId, mainPageId) {
    ...
    SRAlert = function() {
        function SRAlert() {
            ...
            if ($readerFeedbackSelector.length === 0) {
                edx.HtmlUtils.append($("body"), edx.HtmlUtils.interpolateHtml(edx.HtmlUtils.HTML('<div id="{readerFeedbackID}" class="sr" aria-live="polite"></div>'), {
        ...
        SRAlert.prototype.readTexts = function(texts) {
            ...
            $.each(texts, function(idx, value) {
                htmlFeedback = edx.HtmlUtils.interpolateHtml(edx.HtmlUtils.HTML("{previous_feedback}<p>{value}</p>\n"), {
                    ...
                    value: edx.HtmlUtils.HTML(value)
                })
            });
...
(function($) {
    ...
    $(document).ready(function($) {
        $("a[rel*=leanModal]").each(function() {
            var $link = $(this), closeButton = $link.data("modalCloseButtonSelector") || ".close-modal", embed;
            $link.leanModal({
                top: 120,
                overlay: 1,
...
var Language = function() {
    "use strict";
    var $settings_language_selector, self = null;
    return {
        init: function() {
